...
export const dictionary = {
  fr: {
    ...
    propose: {
      ...
      willDownloadIn: "Vous allez télécharger le guide en {language}.",
      changeLanguage: "Télécharger dans une autre langue ?",
    ...
    categories: {
      ...
      monument: "Monument",
      museum: "Musée",
      natural_landmark: "Site naturel",
      public_square: "Place publique",
      samba_school: "École de samba",
      theater: "Théâtre",
    ...
    auth: {
      ...
      switchToRegister: "Pas encore de compte ? Créez-en un",
    ...
    settings: {
      ...
      deleteAccountConfirmMessage: "Cette action est définitive. Votre profil et vos données synchronisées seront supprimés. Vos téléchargements déjà sur cet appareil ne sont pas affectés.",
  ...
  en: {
    ...
    propose: {
      ...
      willDownloadIn: "You'll download the guide in {language}.",
      changeLanguage: "Download in another language?",
    ...
    settings: {
      ...
      deleteAccountConfirmMessage: "This is permanent. Your profile and synced data will be deleted. Downloads already on this device are not affected.",
  ...
  pt: {
    ...
    propose: {
      ...
      willDownloadIn: "Você vai baixar o guia em {language}.",
      changeLanguage: "Baixar em outro idioma?",
    ...
    categories: {
      ...
      monument: "Monumento",
      museum: "Museu",
      natural_landmark: "Marco natural",
      public_square: "Praça pública",
      samba_school: "Escola de samba",
      theater: "Teatro",
    ...
    auth: {
      ...
      passwordLabel: "Senha",
      loginCta: "Entrar",
      registerCta: "Criar minha conta",
      switchToRegister: "Ainda não tem conta? Crie uma",
    ...
    settings: {
      ...
      deleteAccountConfirmMessage: "Esta ação é definitiva. Seu perfil e seus dados sincronizados serão excluídos. Os downloads já neste aparelho não são afetados.",
  ...
  es: {
    ...
    propose: {
      ...
      willDownloadIn: "Vas a descargar la guía en {language}.",
      changeLanguage: "¿Descargar en otro idioma?",
    ...
    categories: {
      ...
      monument: "Monumento",
      museum: "Museo",
      natural_landmark: "Paraje natural",
      public_square: "Plaza pública",
      samba_school: "Escuela de samba",
      theater: "Teatro",
    ...
    settings: {
      ...
      deleteAccountConfirmMessage: "Esta acción es definitiva. Tu perfil y tus datos sincronizados se eliminarán. Las descargas ya en este dispositivo no se ven afectadas.",
      deleteAccountCancel: "Cancelar",
